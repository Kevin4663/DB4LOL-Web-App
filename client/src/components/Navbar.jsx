      ...
      <div className="mx-auto maxw-w-6xl p-4">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
                ...
                <Link to={"https://www.leagueoflegends.com/en-us/news/tags/patch-notes/"} target="_blank" className="btn btn-primary">
                    <span>{version || "Loading..."}</span>
                </Link>
                <Link to={"https://github.com/Kevin4663"} target="_blank" className="btn btn-primary">
                    <span>Github</span>
                </Link>
            </div>
        </div>
